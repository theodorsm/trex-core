...
class CRFC2544Info {
 public:
    ...
    inline void add_time_lat(std::array<dsec_t, 2> v) {m_time_lat_vector.push_back(v);}
 ...
 private:
    ...
    std::vector<std::array<dsec_t, 2>> m_time_lat_vector; // vector containing array with timestamp and latency
};
